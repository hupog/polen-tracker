...
public record PollenCollection(
    UUID id,
    ...
    Instant completedAt,
    int producedItems) {
  public static PollenCollection pending(
      UUID id, PollenSourceType sourceType, Instant requestedAt) {
  ...
  public PollenCollection fail(Instant at) {
    return new PollenCollection(
        id, sourceType, CollectionStatus.FAILED, requestedAt, at, producedItems);
  }
}
